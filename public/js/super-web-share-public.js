...
document.addEventListener("click", function (SuperWebShare) {
  ...
  if (
    target.classList.contains("superwebshare_prompt") ||
    target.parentNode.classList.contains("superwebshare_prompt") ||
    target.parentNode.parentNode.classList.contains("superwebshare_prompt")
  ) {
