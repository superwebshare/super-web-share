...
class Super_Web_Share {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Super_Web_Share_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	...
	public function __construct() {
		if ( defined( 'SUPERWEBSHARE_VERSION' ) ) {
			$this->version = SUPERWEBSHARE_VERSION;
		} else {
			$this->version = '1.0';
		}
		$this->plugin_name = 'super-web-share';
	...
	private function define_admin_hooks() {
		...
		$plugin_admin = new Super_Web_Share_Admin( $this->get_plugin_name(), $this->get_version() );
	...
	private function define_public_hooks() {
		...
		$plugin_public = new Super_Web_Share_Public( $this->get_plugin_name(), $this->get_version() );
	 ...
	 *
	 * @since     1.0.0
	 * @return    Super_Web_Share_Loader    Orchestrates the hooks of the plugin.
	 */
