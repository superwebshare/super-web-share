...
class Super_Web_Share_Icons {
    ...
    function get_icon( $icon_name = "" ){
        ...
        if( ! empty( $icon_name ) ){
            ...
            if( isset( $this->icons[ $icon_name ] ) ){
                ...
                return $this->generate_svg( $this->icons[ $icon_name ] );
    ...
    private function generate_svg( array $icon_prop ){
        ...
        $svg = '<svg xmlns="http://www.w3.org/2000/svg" class="superwebshare-svg" fill="' . $svg_pros[ 'fill' ] . '" viewBox="0 0 1000 1000" stroke="currentColor" stroke-width="' . $svg_pros[ 'stock-width' ] . '">';
